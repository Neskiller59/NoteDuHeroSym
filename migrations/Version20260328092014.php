 ...
 */
final class Version20260328092014 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pnj (id INT AUTO_INCREMENT NOT NULL, hero_id INT NOT NULL, name VARCHAR(300) NOT NULL, description LONGTEXT NOT NULL, information LONGTEXT DEFAULT NULL, localisation VARCHAR(255) DEFAULT NULL, personnalite VARCHAR(1000) DEFAULT NULL, competence LONGTEXT DEFAULT NULL, INDEX IDX_FDA97F2D45B0BCD (hero_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
